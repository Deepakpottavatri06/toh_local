...
export default function Navbar({ signInButton }) {
  ...
  return (
    <nav className="container navbar navbar-expand-lg border border-2 border-white rounded-5 w-75 mt-3  border-body top" style={{ background: '#333333' }} data-bs-theme="dark">
      <div className="container-fluid">
