...
export default function TollStart(props) {
    ...
    return (
            ...
            <div className="parenth">
                <div className="mt-5 d-flex container border border-light border-2 shadow-lg flex-column justify-content-center align-items-center rounded-4 p-4"style={{ backdropFilter:'blur(3px)',maxWidth:'600px'  }}>
